...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <div class="container" style="margin-top: auto">
        <a class="navbar-brand  text-white" href="#"><h3>CourseOffer™</h3></a>
    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                <h5 class="text-uppercase">Dear client</h5>
                <p>
                ...
                <div class="row">
                    <div class="col-6">
                        <ul class="list-unstyled">
                            <li>
                                <a href="https://getbootstrap.com/" class="text-white" style="text-decoration: none"><i
                                            class="bi bi-bootstrap-fill"></i> Bootstrap 5</a>
                            </li>
                            <li>
                                <a href="https://icons.getbootstrap.com/" class="text-white"
                                   style="text-decoration: none"><i class="bi bi-bootstrap-fill"></i> Bootstrap
                                    icons</a>
                            </li>
                            <li>
                                <a href="https://mdbootstrap.com/" class="text-white" style="text-decoration: none"><i
                                            class="bi bi-pie-chart"></i> Material Design for Bootstrap</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <ul class="list-unstyled">
                            <li>
                                <a href="https://fontawesome.com/" class="text-white" style="text-decoration: none"><i
                                            class="bi bi-file-font-fill"></i> Font Awesome</a>
                            </li>
                            <li>
                                <a href="https://www.svgrepo.com/" class="text-white" style="text-decoration: none">
